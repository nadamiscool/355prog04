...
class Customer { 
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/nadamiscool/355prog04.git' target='_blank'>Github</a><br />
                <a href='logout.php'>Log Out</a><br />
                <a href='http://localhost/355prog04/uploads/' target='_blank'>upload01 pictures link</a><br />
                <div class='container'>
                    <p class='row'>
                    ...
                    <p>
                        ...
                        <a href='upload01.html?fun=display_create_form' class='btn btn-success'>upload01</a>
                        <a href='upload03.html?fun=display_create_form' class='btn btn-success'>upload02</a>
                        <a href='upload02.html?fun=display_create_form' class='btn btn-success'>upload03</a>
                    </p>
                    <div class='row'>
        ...
        foreach ($pdo->query($sql) as $row) {
          ...
          //  echo "<td>". '<img src="data:image/jpeg;base64,'.base64_encode( $row['content'] ).'/" width="100" height="100">' . "</td>";
